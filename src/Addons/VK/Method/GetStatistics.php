...
class GetStatistics
{
     ...
     * {"type":"integer"}
     */
    public function account_id(integer $account_id) : GetStatistics
    {
     ...
     */
    public function ids_type(string $ids_type) : GetStatistics
    {
     ...
     * {"type":"string"}
     */
    public function ids(string $ids) : GetStatistics
    {
        $this->params['ids'] = $ids;
        return $this;
    }
     ...
     */
    public function period(string $period) : GetStatistics
    {
     ...
     * {"type":"string"}
     */
    public function date_from(string $date_from) : GetStatistics
    {
     ...
     * {"type":"string"}
     */
    public function date_to(string $date_to) : GetStatistics
    {

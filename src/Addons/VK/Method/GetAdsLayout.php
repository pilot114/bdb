...
class GetAdsLayout
{
     ...
     * {"type":"integer"}
     */
    public function account_id(integer $account_id) : GetAdsLayout
    {
     ...
     * {"type":"integer"}
     */
    public function _client_id(integer $_client_id) : GetAdsLayout
    {
     ...
     * {"type":"boolean"}
     */
    public function _include_deleted(boolean $_include_deleted) : GetAdsLayout
    {
     ...
     * {"type":"string"}
     */
    public function _campaign_ids(string $_campaign_ids) : GetAdsLayout
    {
     ...
     * {"type":"string"}
     */
    public function _ad_ids(string $_ad_ids) : GetAdsLayout
    {
     ...
     * {"type":"integer"}
     */
    public function _limit(integer $_limit) : GetAdsLayout
    {
     ...
     * {"type":"integer"}
     */
    public function _offset(integer $_offset) : GetAdsLayout
    {

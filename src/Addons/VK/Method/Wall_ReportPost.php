...
class Wall_ReportPost extends \Bdb\Addons\VK\BaseMethod
{
     ...
     * {"type":"integer"}
     */
    public function owner_id(integer $owner_id) : Wall_ReportPost
    {
     ...
     */
    public function post_id(integer $post_id) : Wall_ReportPost
    {
     ...
     */
    public function _reason(integer $reason) : Wall_ReportPost
    {
